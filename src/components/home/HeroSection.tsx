        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          >
            ...
            >
              ...
              <Image
                src="/adesso-icon.webp"
                alt="ADESSO"
                width={140}
                height={140}
                priority
                className="relative w-20 md:w-24 h-auto object-contain drop-shadow-[0_0_25px_rgba(201,168,76,0.4)]"
              />
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <span className="text-gradient-gold inline-block">{t.hero.titleHighlight}</span>
            <br />
          ...
          >
            <MagneticButton href={whatsappUrl} target="_blank" rel="noopener noreferrer" strength={20}>
              <span className="group flex items-center gap-3 px-8 py-4 rounded-full bg-gradient-to-r from-gold-dark via-gold to-gold-light text-black font-bold text-lg shadow-lg shadow-gold/20 hover:shadow-2xl hover:shadow-gold/40 transition-shadow duration-300">
                {t.hero.cta1}
          ...
          >
            {[
              ...
              <motion.div
                ...
                className="glass rounded-2xl p-4 md:p-6 text-center backdrop-blur-lg card-hover relative overflow-hidden group"
              ...
              >
                ...
                <div className="relative text-2xl md:text-4xl font-bold text-gradient-gold mb-1">{stat.value}</div>
                <div className="relative text-white/50 text-xs uppercase tracking-wider">{stat.label}</div>
              </motion.div>
            ))}
          </motion.div>
        </div>
